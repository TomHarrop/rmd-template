...
\setbeamercolor{itemize item}{fg=bcpink}        % bullets
\setbeamercolor{itemize subitem}{fg=bcpink}     % sub-bullets
\setbeamercolor{itemize subsubitem}{fg=bcpink}  % sub-sub-bullets
\setbeamercolor{enumerate item}{fg=bcpink}      % numbered lists
% \setbeamercolor{block title}{fg=headingcolour,bg=bcpink}
% \setbeamercolor{block body}{fg=headingcolour,bg=bcpink}
\setbeamercolor{alerted text}{fg=bcpink}
\setbeamercolor{description item}{fg=bcpink}

% Alert block
\setbeamertemplate{blocks}[rounded]
\setbeamercolor{block title}{fg=textcolour, bg=structure.bg}
\setbeamercolor{block body}{fg=textcolour, bg=structure.bg}
\setbeamercolor{block title alerted}{fg=bcpink, bg=paleheadingcolour!75}
\setbeamercolor{block body alerted}{fg=bcpink, bg=paleheadingcolour!25}
