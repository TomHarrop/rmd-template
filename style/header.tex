...
\setbeamercolor{block title alerted}{fg=textcolour, bg=paleheadingcolour!75}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% BACKGROUND COLOUR FOR TT %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%


% redifine the texttt command to include background colouring
% \LetLtxMacro\latextexttt\texttt
% \renewcommand{\texttt}[1]{%
%   {\fboxsep0.1ex\colorbox{paleheadingcolour}{%
%     \hspace{0.15ex}%
%       \strut\textcolor{textcolour}{\latextexttt{#1}}%
%     \hspace{0.15ex}%
%     }%
%   }%
% }
