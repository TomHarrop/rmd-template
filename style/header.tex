...
\title{Introduction to RNA sequencing}


\logo{
  \begin{tikzpicture}[remember picture, overlay]
    \node[at=(current page.south east),anchor=south east,inner xsep=0.66\footskip,inner ysep=\footskip]{
      \latexincludegraphics[height=0.5cm]{img/Galaxy-Aust-Logo-Stacked-RGB.pdf}

    };
    \node[at=(current page.south west),anchor=south west,inner xsep=0.66\footskip,inner ysep=\footskip]{
      \latexincludegraphics[height=0.5cm]{img/UoM_Logo_Vert_Housed_RGB.eps}
    };
  \end{tikzpicture}
}
...
\definecolor{linkcolour}{RGB}{0, 60, 85}      % Laughing Kookaburra dark
\definecolor{bulletcolour}{RGB}{70, 200, 240}  % Laughing Kookaburra light
...
\setbeamercolor{block title}{fg=textcolour, bg=} % empty is transparent
\setbeamercolor{block body}{fg=textcolour, bg=}
...
% Note: to suppress the \logo on the title page, leave the title blank in the
% YAML front matter, and add \frame[plain]{\titlepage} to body.tex
...
\setbeamertemplate{title page}{
  \begin{tikzpicture}[remember picture,overlay]
    \node[at=(current page.north west),anchor=north west,outer xsep=1in+\oddsidemargin,outer ysep=14pt] {
      \latexincludegraphics[keepaspectratio,
        height=0.3\paperheight]{img/UoM_Logo_Vert_Housed_RGB.eps}
    };
...
\setbeamertemplate{section page}{
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[at=(current page.north east),anchor=north east,outer xsep=1in+\oddsidemargin,outer ysep=14pt] {
      \latexincludegraphics[keepaspectratio,
...
\setbeamertemplate{footline}{%
  \hfill \insertframenumber/\inserttotalframenumber \hspace*{0.66\footskip}
  \vspace*{1ex}
  }
