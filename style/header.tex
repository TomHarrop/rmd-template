...
\institute[]{
  \href{https://www.biocommons.org.au/}{Australian BioCommons}
  and
  \href{https://unimelb.edu.au}{the University of Melbourne}
}

\title{Automatic reference genome assembly for Australian species}
...
\logo{
  \begin{tikzpicture}[remember picture, overlay]
    ...
    \node[at=(current page.north west),
      ...
      \latexincludegraphics[width=1.4cm]{img/Australian-Biocommons-Logo-Stacked-RGB.pdf}
    };
  \end{tikzpicture}
}
...
% Enable Atkinson Hyperlegible (https://tug.org/FontCatalogue/atkinsonhyperlegible/)
...
% title fonts
\setbeamerfont{title}{parent=atkinson}
\setbeamerfont{subtitle}{size=\small,parent=atkinson}
\setbeamerfont{author}{size=\scriptsize,parent=atkinson}
\setbeamerfont{institute}{size=\scriptsize,parent=atkinson}
\setbeamerfont{date}{size=\scriptsize,parent=atkinson}
...
\definecolor{headinggrey}{HTML}{797979}   % grey
\colorlet{paleheadingcolour}{headinggrey!50!}

\definecolor{bcpink}{HTML}{ed087c}   % biocommons pink
\definecolor{bcgold}{HTML}{f49f1d}   % biocommons gold
\definecolor{bcgreen}{HTML}{5ac3b1}   % biocommons green
\colorlet{linkcolour}{bcpink}

% Place colours
\setbeamercolor{title}{fg=headinggrey}
\setbeamercolor{frametitle}{fg=headinggrey}
\setbeamercolor{normal text}{fg=textcolour}
\setbeamercolor{itemize item}{fg=bcgreen}        % bullets
\setbeamercolor{itemize subitem}{fg=bcgreen}     % sub-bullets
\setbeamercolor{itemize subsubitem}{fg=bcgreen}  % sub-sub-bullets
\setbeamercolor{enumerate item}{fg=bcgreen}      % numbered lists
% \setbeamercolor{block title}{fg=headingcolour,bg=bcgreen}
% \setbeamercolor{block body}{fg=headingcolour,bg=bcgreen}
\setbeamercolor{alerted text}{fg=bcgreen}
\setbeamercolor{description item}{fg=bcgreen}

% Alert block
\setbeamertemplate{blocks}[rounded]
\setbeamercolor{block title}{fg=textcolour, bg=structure.bg}
\setbeamercolor{block body}{fg=textcolour, bg=structure.bg}
\setbeamercolor{block title alerted}{fg=bcgreen, bg=paleheadingcolour!75}
\setbeamercolor{block body alerted}{fg=bcgreen, bg=paleheadingcolour!25}
...
\setbeamertemplate{title page}{
  \begin{tikzpicture}[remember picture,overlay]
    \node[at=(current page.north west),
      anchor=mid west,
      yshift=-0.3\paperheight,
      xshift=\marginparpush +\marginparsep + \marginparwidth
    ] {\latexincludegraphics[keepaspectratio,
      height=0.2\paperheight]{img/abc_crop.pdf}
    };
    % second logo
    \node[at=(current page.north east),
      ...
      height=0.2\paperheight]{img/UoM_logo_Horiz_housed_RGB.eps}
    };
  \end{tikzpicture}
  \begin{center}
...
\setbeamertemplate{section page}{
  \begin{tikzpicture}[remember picture,overlay]
    \node[at=(current page.north west),anchor=north west] {
      \latexincludegraphics[keepaspectratio,
      height=0.3\paperheight]{img/Australian-Biocommons-Logo-Horizontal-RGB.pdf}
    };
  \end{tikzpicture}
  \begin{center}
    \vspace{0.1\paperheight}
...
% As for the title page, a plain frame on the sectionpage suppresses the \logo
\AtBeginSection[]{
...
\definecolor{Helotiales}{HTML}{440154}
\definecolor{Asparagales}{HTML}{481A6C}
\definecolor{Poales}{HTML}{472F7D}
\definecolor{Canellales}{HTML}{414487}
\definecolor{Decapoda}{HTML}{39568C}
\definecolor{Hymenoptera}{HTML}{31688E}
\definecolor{Gobiiformes}{HTML}{2A788E}
\definecolor{Clupeiformes}{HTML}{23888E}
\definecolor{Synbranchiformes}{HTML}{1F988B}
\definecolor{Atheriniformes}{HTML}{22A884}
\definecolor{Centrarchiformes}{HTML}{35B779}
\definecolor{Anura}{HTML}{54C568}
\definecolor{Squamata}{HTML}{7AD151}
\definecolor{Passeriformes}{HTML}{A5DB36}
\definecolor{Peramelemorphia}{HTML}{D2E21B}
\definecolor{Chiroptera}{HTML}{FDE725}
